...
\usepackage{graphicx}
\usepackage[a4paper, margin=2.14cm]{geometry}
...
\usepackage{float}
\usepackage{textcomp}
\usepackage{tabularx,ragged2e,array,float}
...
\newcommand{\myReportSubtitle}{A deployable weather station network and linked microclimate forecasting webapp}
\newcommand{\wordCount}{15,941}
...
\makeatletter
\pretocmd{\section}{\vspace*{1cm}\thispagestyle{plain}}{}{}
\makeatother
